                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="segmen/edit/{{$sgm->id}}" class="btn btn-warning btn-sm" >Edit</a>
                            @if($k != 1 && $k == $m)
                            <a href="segmen/hapus/{{$sgm->id}}" class="btn btn-secondary btn-sm">Hapus</a>
                            @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action='segmen/create' method='GET' name="tambah" id="tambah">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold" for="InputNim">SEGMEN *Huruf Besar</label>
                            <input name="segmen" type="text" class="form-control" id="segmen" value="">
                        </div>
