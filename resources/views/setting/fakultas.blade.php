        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <table class="table table-striped">
                    ...
                    @foreach($data_fakultas as $no => $fk)
                    <tr>
                        <td>{{$fk->id_fk}}</td>
                        <td>{{$fk->fakultas}}</td>
                        <td>
                            <a href="fakultas/edit/{{$fk->id}}" class="btn btn-warning btn-sm" >Edit</a>
                            <a href="fakultas/hapus/{{$fk->id}}" class="btn btn-secondary btn-sm">Hapus</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="ModalLabel">Tambah Daftar Fakultas</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action='fakultas/create' method='GET' name="tambah" id="tambah">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label class="font-weight-bold" for="InputNim">Id Fakultas</label>
                            <input name="id_fk" type="text" class="form-control" id="id_fk" value="">
                        </div>
                        <div class="form-group">
