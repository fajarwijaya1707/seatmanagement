...
@section('main-card')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endforeach
            <form action="../../prodi/update/{{$p->id}}" method='GET' id="update">
                {{csrf_field()}}
                <div class="form-group">
                    <label class="font-weight-bold" for="EditNim">ID PRODI</label>
                    <input name="id" type="text" class="form-control" id="id" value="{{$p->id}}">
                </div>
                <div class="form-group">
                    <label class="font-weight-bold" for="EditNim">NAMA PRODI</label>
                    <input name="prodi" type="text" class="form-control" id="prodi" value="{{$p->prodi}}">
                </div>
                <div class="form-group">
                    <label class="font-weight-bold" for="EditNim">NAMA FAKULTAS</label>
                    <input name="fakultas" type="text" class="form-control" id="fakultas" value="{{$p->fakultas}}">
                </div>
