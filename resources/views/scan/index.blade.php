  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Halaman Booking</a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="#" onclick="goback()">kembali</a></li>
          <li class="menu-active"><a href=""data-toggle="modal" data-target="#Modal2"> Petunjuk Booking</a></li>
          ...
          <div id="introCarousel" class="carousel  slide carousel-fade" >
            ...
            <div class="carousel-inner" role="listbox">
              ...
              <div class="col-md-12 wow fadeInUp" align="center">
                ...
                <canvas autoplay="true" id="video-webcam"></canvas>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="ion-ios-arrow-right"></i> <a href="awal">Halaman Awal</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a data-toggle="modal" data-target="#Modal2">Petunjuk Booking</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a data-toggle="modal" data-target="#Modal">Petunjuk Checkin</a></li>
            </ul>
          </div>
