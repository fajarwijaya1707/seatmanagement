...
<head>
  ...
  <script>
      function initialize(){
          var propertiPeta = {
              center:new google.maps.LatLng(-8.5830696,116.3202515),zoom:9,
              mapTypeId:google.maps.mapTypeId.ROADMAP
          };
          ver peta = new google.maps.map(document.getElementById"gooogleMap"), propertiPeta);
      }
...
<body>
    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="" data-toggle="modal" data-target="#Modal3">Denah Lokasi</a></li>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p>Dapatkan Tempat Duduk Anda Dengan Mudah.</p><br>
                <a href="scanhp" class="btn-get-started scrollto">Booking</a><br>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Mudah</h2>
                <p>Bukan Hanya memudahkan mendapatkan tempat duduk akan tetapi aplikasi ini juga mudah untuk dipahami/digunakan.</p><br>
                <a href="scanhp" class="btn-get-started scrollto">Booking</a><br>
                <a href="#featured-services" class="btn-get-started scrollto">Detail</a>
              </div>
            </div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Cepat</h2>
                <p>Dapatkan dan temukan tempat duduk anda dengan cepat tanpa mengantri.</p><br>
                <a href="scanhp" class="btn-get-started scrollto">Booking</a><br>
                <a href="#featured-services" class="btn-get-started scrollto">Detail</a>
              </div>
            </div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Tepat</h2>
                <p>Terciptanya Tempat duduk dengan Tepat dan Rapi tanpa menggangu tamu undangan yang lain.</p><br>
                <a href="scanhp" class="btn-get-started scrollto">Booking</a><br>
                <a href="#featured-services" class="btn-get-started scrollto">Detail</a>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 box">
            ...
            <center><a href="" align="center" data-toggle="modal" data-target="#Modal2"> --> Detail <--</a></center>
          </div>
 ...
 <div class="modal fade" id="Modal3" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center><div class="modal-header">
               <h5 class="modal-title font-weight-bold" id="ModalLabel">Denah Lokasi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
          ...
          <div class="form-group">
            <label>&emsp; Denah Lokasi :</label>
            <center><p>Gedung Prof. Amin Abdullah (Multi Purpose)</p><br><img src="../public/assets/img/lokasi2.png" height="400px" width="350px"></center>
          </div>
                    <div class="modal-footer">
                        <a href="awal" class="btn btn-secondary" data-dismiss="modal">Tutup</a>
                    </div>
